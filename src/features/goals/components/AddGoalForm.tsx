      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="relative">
            ...
            <input
              className="w-full rounded-xl border border-zinc-200 py-3 pr-4 pl-7 text-sm transition outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white"
              type="number"
              placeholder="Target"
              value={target}
