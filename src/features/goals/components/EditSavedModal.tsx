...
//       // هم optimistic update هم invalidate برای اطمینان
...
//     try {
//       console.log('step 2: calling updateGoalSaved', {
//         id: goalId,
//         saved: validSaved,
//       })
...
//           <h2 className="font-bold text-zinc-900">Update Progress</h2>
//           <button type="button" onClick={onClose}>
//             ✕
//           </button>
//         </div>

//         <p className="mb-4 text-sm text-zinc-500">{goalTitle}</p>
...
//           <button
//             type="button" // ← submit رو عوض کن به button
...
//             className="w-full rounded-xl border border-red-300 py-3 text-sm text-red-500 transition hover:bg-red-50 disabled:opacity-50"
//           >
